...
class EditprofileWidget extends StatefulWidget {
  static const String routName = 'Edit_profile Page';
...
class _EditprofileWidgetState extends State<EditprofileWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??= TextEditingController(
      text: '${SharedHelper.getUser()["name"]}',
    );
    _model.textFieldFocusNode1 ??= FocusNode();

    // _model.textController2 ??=
    //     TextEditingController(text: '${SharedHelper.getUser()["email"]}');
    // _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??=
        TextEditingController(text: '${SharedHelper.getUser()["phone"]}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color(0xFF0B0A0C),
